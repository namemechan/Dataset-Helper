...
- **편의 기능 및 리핏 자동화:** 
    ...
    - **리핏 평균화 [New]:** 데이터셋이 적은 폴더들이 전체 평균에 도달하도록 리핏을 **2의 거듭제곱(2, 4, 8...)** 단위로 넉넉하게 자동 상향하여 데이터 간의 균형을 맞춥니다. (평균 이상의 폴더는 1로 설정)
    - **최적 리핏 설정:** 배치 사이즈를 고려하여 낭비율을 0%에 가깝게 만드는 권장 리핏을 자동 적용합니다.
- **직관적인 분석 지표:** 
